  ...
  return (
    <div className='min-h-screen bg-background text-foreground flex overflow-hidden font-sans relative'>
      ...
      <div className='w-full flex flex-col'>
        <header className='w-full h-18 flex items-center justify-between px-4 sticky top-0 z-10 bg-background/30 backdrop-blur-[10px] border-b border-white/5'>
          <div className='flex items-center gap-4'>
            ...
            <div className='flex items-center gap-4'>
              <div className='flex'>
                <img src={SFG_LOGO} alt='SFG Logo' className='w-auto h-10' />
              </div>
              <div className='flex'>
                <img src={POLICE_LOGO} alt='SFG Logo' className='w-auto h-16' />
              </div>
              <div className='flex'>
                <img
                  src={GOVERNMENT_LOGO}
        ...
        <div className='w-full '>
          ...
          <aside
            ...
            className={cn(
              'bg-background/40 backdrop-blur-[10px] border-r border-sidebar-border/50 transition-all duration-500 ease-in-out flex flex-col z-40 shadow-2xl fixed top-[4.5rem] left-0 h-[calc(100vh-4.5rem)] w-64',
              ...
              <div className='h-13 border-t border-white/5 bg-background/50 backdrop-blur-md px-8 flex items-center justify-between text-[10px] text-muted-foreground uppercase tracking-widest'>
                <div className='flex items-center gap-4'>
                  <span className='flex items-center gap-2'>
                    <Copyright className='w-3 h-3' /> COPY RIGHTS 2025, DUBAI
                    POLICE DEPARTMENT
                  </span>
                </div>
                <div className='flex items-center gap-4'>
