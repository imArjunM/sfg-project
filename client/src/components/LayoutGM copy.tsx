      ...
      <main className="flex-1 flex flex-col min-w-0 bg-transparent">
        ...
        <header className="h-20 flex items-center justify-between px-8 sticky top-0 z-10 bg-background/80 backdrop-blur-xl border-b border-white/5">
          <div className="flex items-center gap-8">
            ...
            {/* GM specific Timer Placeholder */}
            <div className="hidden lg:flex items-center gap-4 px-4 py-1.5 bg-black/20 rounded-full border border-white/5">
                <Clock className="w-4 h-4 text-brand-bright-green animate-pulse" />
                <span className="text-xs font-mono text-brand-bright-green tracking-widest">NEXT SESSION: 14:30:00</span>
            </div>
          </div>
            ...
            <div className="flex items-center gap-2">
                ...
                <DropdownMenuTrigger asChild>
                    ...
                    <div className="flex flex-col items-start text-left">
                        ...
                        <span className="text-[10px] text-brand-bright-green uppercase tracking-wider font-bold mt-1">Game Master</span>
                    </div>
                    </Button>
                </DropdownMenuTrigger>
